                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <item.icon
                              className={`h-5 w-5 ${isSelected ? "text-primary-foreground/80" : "text-muted-foreground"}`}
                            />
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-3 min-w-0">
                            <Box
                              className={`h-5 w-5 flex-shrink-0 ${isSelected ? "text-primary-foreground/80" : "text-muted-foreground"}`}
                            />
                            <div className="flex flex-col min-w-0">
                              <span className="font-medium truncate">{asset.name}</span>
                              <span
                                className={`text-xs ${isSelected ? "text-primary-foreground/70" : "text-muted-foreground"} font-mono truncate`}
                              >
                          ...
                          <ArrowRight
                            className={`h-4 w-4 ${isSelected ? "opacity-100" : "opacity-0 text-muted-foreground"} transition-opacity`}
                          />
                        </div>
                      );
                    })}
                        ...
                        >
                          <div className="flex items-center gap-3 min-w-0">
                            ...
                            <div className="flex flex-col min-w-0">
                              ...
                              <span
                                className={`text-xs ${isSelected ? "text-primary-foreground/70" : "text-muted-foreground"} truncate`}
                              >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-t border-border/50 bg-secondary/20">
          <div className="flex items-center gap-4 text-xs text-muted-foreground">
            <span className="flex items-center gap-1">
              <MonitorSmartphone className="h-3 w-3" /> Navigation
            </span>
            <span className="flex items-center gap-1">
          ...
          <div className="hidden sm:flex items-center gap-2">
            <span className="text-[10px] text-muted-foreground font-medium flex items-center gap-1">
              <kbd className="font-mono bg-secondary/50 px-1.5 py-0.5 rounded border border-border/50">
                &uarr;
              </kbd>
              <kbd className="font-mono bg-secondary/50 px-1.5 py-0.5 rounded border border-border/50">
                &darr;
