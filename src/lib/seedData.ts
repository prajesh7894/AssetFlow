  ...
  const maintenance = [
    {
      ...
      issue: "Bulb warning msg, dim light",
      priority: "Medium",
      status: "In Progress",
      technician: "Tech Dave",
      reportedAt: new Date(Date.now() - 86400000).toISOString(),
      history: [
        { date: new Date(Date.now() - 86400000).toISOString(), action: "Ticket Created" },
        { date: new Date(Date.now() - 40000000).toISOString(), action: "Assigned to Tech Dave" },
      ],
    },
    {
      id: "m-2",
      assetId: "AF-0003",
      title: "Chair assembly required",
      issue: "Delivered in box",
      priority: "Low",
      status: "Approved",
      technician: null,
      reportedAt: new Date(Date.now() - 172800000).toISOString(),
      history: [
        { date: new Date(Date.now() - 172800000).toISOString(), action: "Ticket Created" },
        { date: new Date(Date.now() - 100000000).toISOString(), action: "Approved by Admin" },
      ],
    },
    {
      id: "m-3",
      ...
      issue: "Power supply failed, needs immediate replacement",
      priority: "Critical",
      status: "Pending",
      technician: null,
    ...
    },
    {
      ...
      status: "Resolved",
      technician: "Tech Dave",
      reportedAt: new Date(Date.now() - 600000000).toISOString(),
      history: [
        { date: new Date(Date.now() - 600000000).toISOString(), action: "Ticket Created" },
        { date: new Date(Date.now() - 500000000).toISOString(), action: "Resolved by Tech Dave" },
      ],
    },
  ];
  ...
  const notifications = [
    {
      id: "n-1",
      userId: "user-1",
      text: "System AF-000 completed run #7 success",
      type: "system",
    ...
    },
    {
      id: "n-2",
      userId: "user-1",
      text: "Asset transfer req by John H. approved",
      type: "approval",
    ...
    },
    {
      id: "n-3",
      userId: "user-1",
      text: "Warning message for asset AF-001 (not charging)",
      type: "alert",
  ...
  const auditLogs = [
    {
      id: "au-1",
      assetTag: "AF-0001",
      expectedLocation: "NY Office Floor 3",
      scannedLocation: "NY Office Floor 3",
      status: "Match",
      timestamp: new Date(Date.now() - 3600000).toISOString(),
      auditor: "Admin",
    },
    {
      id: "au-2",
      assetTag: "AF-0002",
      expectedLocation: "NY Office Floor 4",
      scannedLocation: "London Office",
      status: "Mismatch",
